...
function HomeBusiness() {
  ...
  let products = input.allProducts.filter(
    (e) => e.businessEmail === input.businessEmailState
  );
  ...
  let soldProducts = [
    {
      id: 1,
      productImage:
        "https://thumbs.dreamstime.com/b/imagen-del-icono-de-la-u%C3%B1a-del-pulgar-de-la-fotograf%C3%ADa-o-del-bot%C3%B3n-de-la-galer%C3%ADa-de-la-imagen-84717969.jpg",
      productName: "zapatos>",
      amount: 2,
      description: "size:41",
