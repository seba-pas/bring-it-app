...
const { Product, Category, Business, City, Province, Purchase, User, Travel, Purchaseitem, Review, Cart, Favorite, Businessbranch } = sequelize.models;
...
Travel.hasMany(Purchase);
Purchase.belongsTo(Travel);
